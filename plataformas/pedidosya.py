...
class PedidosYa(PlataformaBase):
    ...
    # dice "Gaseosa cola | Unavailable for today | Unavailable indefinitely".
    ...
    #       wk-menu-list-category-item.menu-category   -> "Platos"
    #       wk-menu-list-category-item.menu-category   -> "Tartas"
    #
